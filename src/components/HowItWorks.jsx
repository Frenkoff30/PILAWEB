const steps = [
  {
    title: 'DOMLUVÍME SE',
    desc: 'Zavolejte nebo napište na Instagram. Řeknete co potřebujete, domluvíme rozměry, množství i termín.',
  ...
  {
    title: 'POŘEŽEME',
    desc: 'Zpracujeme kulatinu na pile. Prkna, trámy, latě nebo jiný profil přesně podle vašich požadavků.',
  ...
  {
    title: 'ODVEZETE SI',
    desc: 'Hotové řezivo si vyzvednete na pile. Rychle, pečlivě a přesně tak, jak jste chtěli.',
