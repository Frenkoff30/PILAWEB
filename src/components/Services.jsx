const services = [
  ...
  },
  {
    ...
    title: 'PILINY',
    desc: 'Piliny suché i čerstvé na topení. Ideální pro kotle na biomasu nebo pro mulčování.',
    points: ['Piliny suché i čerstvé', 'Vhodné na topení', 'Vhodné pro biomasu'],
    accent: '#A67830',
  },
]
...
const products = [
  ...
  { name: 'Piliny', sub: 'Na topení', desc: 'Suché i čerstvé pro kotle na biomasu.' },
]
